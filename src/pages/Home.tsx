...
const Home: React.FC = () => {
  ...
  const { joinSession } = useSessionManager();
  ...
  const handleJoinGame = async () => {
    ...
    try {
      ...
      const result = await joinSession(sessionId, nickname, selectedAvatar);
            ...
            <div className="flex flex-col items-center">
              <div className="relative">
                <button
                  ...
                  className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-gray-200 hover:bg-gray-300 rounded-full p-2 transition-colors"
                ...
                <button
                  ...
                  className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-gray-200 hover:bg-gray-300 rounded-full p-2 transition-colors"
